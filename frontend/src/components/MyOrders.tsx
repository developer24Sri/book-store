...
interface SortConfig {
    key: keyof IOrder | 'placedAt' | 'finalAmount' | 'orderStatus' | null;
...
const MyOrders = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="min-h-screen bg-linear-to-br pt-28 from-[#43C6AC]/90 to-[#2B5876]/90 py-8">
                <div className="max-w-7xl mx-auto px-4">
                    {/* Header */}
                    <div className="flex items-center mb-8">
                        <button
                            onClick={() => window.history.back()}
                            className="flex items-center text-[#1A237E] hover:text-white transition-colors"
                        >
                                    ...
                                    <tr>
                                        {[
                                            ...
                                            <th
                                                ...
                                                onClick={() => col.key && handleSort(col.key as keyof IOrder)}
                                            >
                                        ...
                                        <tr key={o._id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4">
                                                <button
                                                    ...
                                                    className="px-3 py-1.5 bg-linear-to-r from-[#1A237E] to-[#43C6AC] text-white rounded-lg text-xs hover:opacity-90 transition-opacity"
                                                >
                                                    View Details
                                                </button>
                                            </td>
                                ...
                                <div className="border rounded-xl p-5">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex justify-between">
                                            ...
                                            <span
                                                className={`px-3 py-1 rounded-full text-xs ${selectedOrder.paymentMethod === "Online Payment"
                                                    ? "bg-purple-100 text-purple-800"
                                                    : "bg-orange-100 text-orange-800"
                                                    }`}
                                            >
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span
                                                className={`px-3 py-1 rounded-full text-xs ${selectedOrder.paymentStatus === "Paid"
