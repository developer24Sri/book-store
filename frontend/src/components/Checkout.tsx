...
const Checkout = () => {
    ...
    if (orderPlaced) {
        return (
            <div className="min-h-screen bg-linear-to-br from-[#43C6AC] to-[#F8FFAE] py-20">
                <div className="container mx-auto px-4 max-w-4xl">
                    <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-green-100 rounded-full mb-6">
                            <CheckCircle className="w-12 h-12 text-green-500" />
                        </div>
                        <h1 className="text-3xl md:text-4xl font-bold bg-linear-to-br from-[#1A237E] to-[#43C6AC] bg-clip-text text-transparent mb-4">
                            Order Confirmed!
                        </h1>
                        <p className="text-gray-600 text-lg mb-8">
                            Thank you for your purchase. Your order has been placed successfully.
                        </p>
                        <div className="bg-linear-to-r from-[#43C6AC]/10 to-[#F8FFAE]/10 rounded-xl p-6 mb-8 max-w-lg mx-auto">
                            ...
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <span className="text-xl font-bold text-[#1A237E]">₹{orderTotal.toFixed(2)}</span>
                            </div>
                        </div>
                        <p className="text-gray-600 mb-8">
                            We're sent a confirmation emial to <span className="font-medium">{formData.email}</span>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link to="/books" className="px-6 my-3 bg-linear-to-r from-[#1A237E] to-[#43C6AC] text-white rounded-lg font-medium hover:opacity-90">
                                Continue Shopping
                            </Link>
